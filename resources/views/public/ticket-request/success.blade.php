...
<head>
    ...
    <title>Request Submitted Successfully - Project Manager</title>
...
<body>
    <div class="success-container">
        <div class="success-card">
            <div class="success-header">
                ...
                <p class="mb-0">Your ticket has been created and is pending review</p>
            </div>
            
            <div class="success-body">
                <div class="tracking-box">
                    <i class="bi bi-ticket-perforated" style="font-size: 40px; color: #667eea;"></i>
                    <h4 class="mt-3">Your Tracking Number</h4>
                    <div class="tracking-token" id="trackingToken">{{ $ticket->tracking_token }}</div>
                    <button class="copy-btn" onclick="copyToken()">
                        <i class="bi bi-clipboard"></i> Copy Tracking Number
                    </button>
                    <p class="text-muted small mt-3 mb-0">
                        <i class="bi bi-info-circle"></i> Save this number to track your request status
                    </p>
                </div>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            console.log('Confirmation email should be sent to: {{ $ticket->guest_email }}');
        });
    </script>
</body>
</html>
